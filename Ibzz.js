...
'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;ttname,;;;\nFN:ttname\nitem1.TEL;waid=6282396328667:+62 823-9632-8667\nitem1.X-ABLabel:Ponsel\nEND:VCARD`,
sendEphemeral: true
}}
}
...
break
case "listsubdomainlllll": case "listsullllbdo": {
if (!isOwner) return IbzzReply(msg.owner)
...
break
case "list_domaillllln": {
let teks = `Belum Tersedia`
Ibzz.sendMessage(m.chat, {text: teks}, {quoted: qpayment})
}
break
break
case "list_panel_privlllllllate": {
...
if (!text) return m.reply(example("apa itu gitar"))
m.reply(msg.wait)
...
break
case "cplllanel": case "addllllpanel": case "buatpllllanel": {
...
break
case "cpanhhhhhhel2": case "addphhhhhanel2": case "buathhhhhhpanel2": {
if (!isOwner && !isReseller) return IbzzReply(msg.owner)
if (global.apikey.length < 1) return m.reply("Apikey Tidak Ditemukan!")
